let spoonacularFullRecipeJSON = #"""
 {
     ...
     "winePairing": {
         ...
         "pairingText": "Salad on the menu? Try pairing with Chardonnay, Sauvignon Blanc, and Gruener Veltliner. Sauvignon Blanc and Gruner Veltliner both have herby notes that complement salads with enough acid to match tart vinaigrettes, while a Chardonnay can be a good pick for creamy salad dressings. You could try Bien Nacido Estate Chardonnay. Reviewers quite like it with a 4.9 out of 5 star rating and a price of about 53 dollars per bottle.",
         "productMatches": [
             {
                 "id": 493260,
                 "title": "Bien Nacido Estate Chardonnay",
                 "description": "Inviting aromas of meyer lemon, chamomile and cut straw burst out of the glass. The bright entry yields to a dense and energetic palate that is all straight lines and mouth watering minerality. ",
                 "price": "$52.99",
                 "imageUrl": "https://spoonacular.com/productImages/493260-312x231.jpg",
                 "averageRating": 0.9800000000000001,
                 "ratingCount": 5.0,
                 "score": 0.9175000000000001,
                 "link": "https://click.linksynergy.com/deeplink?id=*QCiIS6t4gA&mid=2025&murl=https%3A%2F%2Fwww.wine.com%2Fproduct%2Fbien-nacido-estate-chardonnay-2016%2F545111"
             }
         ]
     },
